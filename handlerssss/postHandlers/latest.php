													...
													if($currentTimestamp < $latestPosts['lifetime'])
														{
															...
															if($conObj->error == "")
																...
																$obj = new miniPost($latestPosts['postIdHash'],$latestPosts['sharedWith'],$days,$postUserName,$latestPosts['subject'],$latestPosts['content'],$latestPosts['starCount'],$latestPosts['commentCount'],$latestPosts['mailCount'],$latestPosts['seenCount'],$timestamp,$followPost,$userIdHash,$latestPosts['userId'],$hasStarred,$outputac,$postOwner );
