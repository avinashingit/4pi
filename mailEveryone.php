...
$sql="SELECT * FROM `users` WHERE  userId ='COE09B008'";
...
while($row=mysql_fetch_array($results))
{
	if($count%10==0)
	{
		...
		$content="<center><a href='http://14.139.187.99/4pi/initial.php?ref=".$row['userIdHash']."'><img src='cid:logo_2u' width='500' height='600' >&nbsp;&nbsp;&nbsp;&nbsp;<br /><h2><a href='http://172.16.1.251/4pi/initial.php?ref=".$row['userIdHash']."'>Register in 4pi.</a><br /><a href='http://172.16.1.251/4pi/'>Link to 4pi.</a></h2>";
