...
<div class="col-md-2" id="userDetails" style="padding:0px !important;" >
	...
	echo '	<h4 class="text-center" ><a title="'.ucwords(strtolower($row->name)).'"href="/4pi/aboutMe/index.php?userId='.$row->userId.'" style="color:white;" >'.ucwords(strtolower(substr($row->alias,0,20))).'...</a></h4>
