...
class miniPoll
{
	...
	function __construct($pollIdHash,$pollQuestion,$pollType,$pollOptions,$pollOptionsType,
		$sharedWith,$hasVoted,$optionVotes,$pollCreationTime,$pollStatus,$isOwner,$isSAC,$approvalStatus)
	{
