...
?>
		...
		<div id="container" >
			...
			<!--  START OF SECRETARIES INFORMATION -->
	    	<div class="col-md-9 col-md-offset-3"  style="float:right;"  >
				...
				<span id="sgs"></span>
				<section class="sac" >
				<div class="secretary" tabindex="1" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-bank"></i> Student General Secretary</div>
							<hr />
						</div>
					</div>
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The SGS shall liaise with the administration on all matters affecting the general student's welfare.</li>
										<li>The SGS shall be involved in projecting the image of the students of IIITD&amp;M Kancheepuram to the public through the media</li>
										<li>The SGS shall look after the interests of the weaker sections of the students.</li>
									</ul>
								</div>
				...
				<span id="aas"></span>
				<section class="sac" >
				<div class="secretary"  tabindex="2" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-mortar-board"></i> Academic Affairs Secretary</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The AAS shall effectively represent the views of the Student Body on academic matters,
especially those related to academic courses.</li>
										<li>The AAS shall help individual students tackle their specific academic problems and shall
take up their problems with the respective authorities.</li>
										<li>The AAS shall co-ordinate with the functioning of all the centralized facilities of an
academic nature, such as the Library, the Computer Centre, the Placement Office, etc., and
also with the RAS in a manner that addresses the needs of the Student Body.</li>
									</ul>
								</div>
							</div>
				...
				<span id="cocas"></span>
				<section  class="sac" >
				<div class="secretary" tabindex="3" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-gears"></i> Co-Curricular Affairs Secretary</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The CCAS shall be responsible for planning and organizing all the Co-curricular activities of
the students.</li>
										<li>The CCAS, together with the help of a faculty appointed by the director, the Co-Curricular
Advisor and other members of the faculty, shall organize annual technical festival of the
Institute.</li>
										<li>The Steering Committee of the annual technical festival
shall monitor the activities of the festival and advise the CCAS on financial and feasibility
issues.</li>
									</ul>
								</div>
							</div>
				...
				<span id="cas"></span>
				<section  class="sac"  >
				<div class="secretary" tabindex="4" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-gift"></i> Cultural Affairs Secretary</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The specific events under the purview of each of the Cultural Affairs Secretaries are:
Lit: Debate, elocution, quizzes, writing events, dramatics, etc.,
Arts: Music events, fine arts, photography, etc.</li>
										<li>The CAS with the help of the Director, the Cultural Advisor and other members of the
faculty, shall organize annual cultural festival of the Institute.</li>
										<li>The CAS shall together be responsible for the organization and conduct of inter-hostel
cultural events.</li>
									</ul>
								</div>
							</div>
				...
				<div class="secretary" tabindex="5" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-home"></i> Hostel Affairs Secretary</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The HAS shall look after the issues regarding the maintenance of the hostels.</li>
										<li>The HAS shall look after the issues concerning all the messes including the issues regarding
the employees of the hostel management and other persons employed by the hostels.</li>
										<li>The HAS shall assist in the running of the vacation messes.</li>
									</ul>
								</div>
							</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The RAS shall effectively represent the views of the research scholars on matters related to
academic research.</li>
										<li>The RAS shall address specific problems of the research scholars and shall take up these
problems with the respective authorities.</li>
										<li>The RAS shall co-ordinate with the functioning of all the centralized facilities of an
academic nature, such as the Library, the Computer Centre, the Placement Office, etc., and
also with the AAS in a manner that addresses the needs of the Student Body.</li>
									</ul>
								</div>
							</div>
				...
				<div class="secretary" tabindex="7" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-futbol-o"></i> Sports Secretary</div>
							<hr />
						</div>
					</div>
...
GFKR) to the respective CSAs and the SAC.</li>
				...
				<span id="sacs"></span>
				<section  class="sac" >
				<div class="secretary" tabindex="8" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-microphone"></i> SAC Speaker</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>The Speaker shall convene and conduct the meetings of the SAC.</li>
										<li>The Speaker shall prepare and be responsible for communicating the approved minutes of
each Regular SAC Meeting (RM) to the GSB within four days after approval. The minutes of a
Special Meeting shall be put forward to the GSB within the next three days.</li>
										<li>The Speaker shall send the minutes of Regular Meetings to all Councilors within three days of
the meetings and if, within four days of the dispatch, no objection is received, the minutes
shall be treated as approved.</li>
									</ul>
								</div>
							</div>
				...
				<span id="sacds"></span>
				<section  class="sac" >
				<div class="secretary" tabindex="9" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-microphone"></i> SAC Speaker - Deputy</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						...
						<div class="col-md-6">
							<div class="reponsibilitiesWrap">
								...
								<div class="responsibilities" >
									<ul>
										<li>When the Speaker is present: </li>
										  <ul>
											<li> The DS shall record the proceedings of the SAC.</li>
											<li> The DS shall assist the Speaker in all matters concerning the SAC . </li>
										  </ul>
									      

										<li> When the speaker is absent:</li>
										  <ul>
 											<li>The DS shall act as the Speaker.</li>
 											<li>The DS shall appoint any other Councilor as Deputy</li>
										  </ul>
				...
				<div class="secretary" tabindex="10" >
					<div class="row" >
						<div class="col-md-12" align="center">
							<div class="secretaryType"><i class="fa fa-won"></i> Boys Hostel Wardens</div>
							<hr />
						</div>
					</div>
				    ...
				    <div class="row" >
						<div class="col-md-6" style="border-right:1px solid #333;" align="center" >
							<div>
...
tournaments.</li>
				...
				<div class="secretary" tabindex="10" >
					<div class="row" >
						<div class="col-md-12" align="center">
							<div class="secretaryType"><i class="fa fa-won"></i> Girls Hostel Warden</div>
							<hr />
						</div>
					</div>
...
hostel, the minutes of every HC meeting.</li>
			...
			<!--	<span id="gaw"></span>
				...
				<div class="secretary" tabindex="10" >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-won"></i> Girls Hostel Asst. Warden</div>
							<hr />
						</div>
					</div>
...
hostel, the minutes of every HC meeting.</li>
				...
				<div class="secretary" tabindex="18"  >
					<div class="row" >
						<div class="col-md-12">
							<div class="secretaryType"><i class="fa fa-building"></i> Girls Hostel General Secretary</div>
							<hr />
						</div>
					</div>
...
hostel library.</li>
				...
				<section  class="sac" >
					<div class="secretary" tabindex="24" >
						<div class="row" >
							<div class="col-md-12">
								<div class="secretaryType"><i class="fa fa-futbol-o"></i> Girls Hostel Sports Secretary</div>
								<hr />
							</div>
						</div>
				...
				<div id="secPosts">
					<!-- THIS CONTAINER WILL HOLD THE POSTS OF EACH Secretary WHEN CLICKED-->
				</div>
			...
			<!--  END OF SECRETARIES INFORMATION -->
	    </div>
